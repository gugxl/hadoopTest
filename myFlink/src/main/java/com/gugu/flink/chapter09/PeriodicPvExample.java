...
public class PeriodicPvExample {
    ...
    // 注册定时器，周期性输出 pv
    static class PeriodicPvResult extends KeyedProcessFunction<String, Event, String> {
        ...
        public void open(Configuration parameters) throws Exception {
            countState = getRuntimeContext()
                .getState(new ValueStateDescriptor<Long>("count", Long.class));
        ...
        public void processElement(Event value, KeyedProcessFunction<String, Event, String>.Context ctx, Collector<String> out) throws Exception {
            ...
            if (timerTsState.value() == null) {
                ctx.timerService().registerProcessingTimeTimer(value.getTimestamp() + 10 * 1000L);
