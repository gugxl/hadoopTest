...
public class IntervalJoinExample {
    ...
    public static void main(String[] args) {
        ...
        SingleOutputStreamOperator<Tuple3<String, String, Long>> orderStream = environment.fromElements(
        ...
        SingleOutputStreamOperator<Event> clickStream = environment.fromElements(
