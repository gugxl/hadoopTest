...
public class BillCheckExample {
    ...
    public static void main(String[] args) {
        ...
        // 来自 app 的支付日志
        SingleOutputStreamOperator<Tuple3<String, String, Long>> appStream = environment.fromElements(Tuple3.of("order-1", "app", 1000L),
        ...
        // 来自第三方支付平台的支付日志
        SingleOutputStreamOperator<Tuple4<String, String, String, Long>> thirdpartStream = environment.fromElements(Tuple4.of("order-1", "third-party", "success", 3000L),
    ...
    static class OrderMatchResult extends CoProcessFunction<Tuple3<String, String, Long>, Tuple4<String, String, String, Long>, String> {
        // 定义状态变量，用来保存已经到达的事件
