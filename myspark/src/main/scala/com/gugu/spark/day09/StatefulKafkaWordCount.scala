...
//    val data: ReceiverInputDStream[(String, String)] = KafkaUtils.createStream(ssc,zkQuorum,groupId,topics)
    val data = KafkaUtils.createDirectStream(ssc,PreferConsistent,ConsumerStrategies.Subscribe[String,String](topics,kafkaParams))
    ...
    //聚合
//    val unit: DStream[(String, Int)] = wordAndOne.reduceByKey(_+_)
